...
export default function HeroSection() {
  const pillars = [
    { title: "Innovation", href: "/innovation", video: "/videos/innovation.mp4" },
    { title: "Vision", href: "/vision", video: "/videos/vision.mp4" },
    { title: "People", href: "/people", video: "/videos/people.mp4" },
    { title: "Legacy", href: "/legacy", video: "/videos/legacy.mp4" },
    { title: "Human Intelligence", href: "/human-intelligence", video: "/videos/human-intelligence.mp4" },
    { title: "Projects & Opportunities", href: "/projects", video: "/videos/projects-loop.mp4" },
  ];
