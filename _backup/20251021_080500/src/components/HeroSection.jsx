...
export default function HeroSection() {
  const pillars = [
    { title: "Innovation", href: "/innovation", video: "/assets/videos/innovation.mp4" },
    { title: "Vision", href: "/vision", video: "/assets/videos/vision.mp4" },
    { title: "People", href: "/people", video: "/assets/videos/people.mp4" },
    { title: "Legacy", href: "/legacy", video: "/assets/videos/legacy.mp4" },
    { title: "Human Intelligence", href: "/human-intelligence", video: "/assets/videos/human-intelligence.mp4" },
    { title: "Projects & Opportunities", href: "/projects", video: "/assets/videos/projects-loop.mp4" },
  ];
